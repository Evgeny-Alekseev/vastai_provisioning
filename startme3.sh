...
UNET_MODELS=(
    # Use new Fun InP diffusion models (UNet) from Kijai instead of older i2v
  "https://huggingface.co/Kijai/WanVideo_comfy_fp8_scaled/resolve/main/Fun/Wan2_2-Fun-InP-A14B-HIGH_fp8_e4m3fn_scaled_KJ.safetensors"
  "https://huggingface.co/Kijai/WanVideo_comfy_fp8_scaled/resolve/main/Fun/Wan2_2-Fun-InP-A14B-LOW_fp8_e4m3fn_scaled_KJ.safetensors"
    # Add extra UNet model URLs here
)

LORA_MODELS=(
    # Use new Lightning 4-step LoRAs instead of lightx2v
  "https://huggingface.co/jrewingwannabe/Wan2.2-Lightning_I2V-A14B-4steps-lora/resolve/main/Wan2.2-Lightning_I2V-A14B-4steps-lora_HIGH_fp16.safetensors"
  "https://huggingface.co/jrewingwannabe/Wan2.2-Lightning_I2V-A14B-4steps-lora/resolve/main/Wan2.2-Lightning_I2V-A14B-4steps-lora_LOW_fp16.safetensors"
...
TEXT_ENCODER_MODELS=(
    # Use new BF16 full-precision text encoder from Kijai instead of FP8 scaled
