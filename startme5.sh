...
LORA_MODELS=(
    ...
    # Qwen Image 2512 LoRAs (Qwen-Edit-2512 workflow notes)
...
# GGUF models
GGUF_MODELS=(
    # Qwen Image 2512 GGUF (Qwen-Edit-2512 workflow notes; Q8_0 matches default in graphs)
...
TEXT_ENCODER_MODELS=(
    ...
    # Полный text encoder (fp8_scaled не качаем)
