...
WORKFLOWS=(
 ...
 "https://raw.githubusercontent.com/Evgeny-Alekseev/vastai_provisioning/refs/heads/main/my_workflow/1-mywan22FLF.json"
...
LORA_MODELS=(
    # Wan 2.2 Lightning I2V-A14B 4steps LoRA
    "https://huggingface.co/jrewingwannabe/Wan2.2-Lightning_I2V-A14B-4steps-lora/resolve/main/Wan2.2-Lightning_I2V-A14B-4steps-lora_HIGH_fp16.safetensors?download=true"
    "https://huggingface.co/jrewingwannabe/Wan2.2-Lightning_I2V-A14B-4steps-lora/resolve/main/Wan2.2-Lightning_I2V-A14B-4steps-lora_LOW_fp16.safetensors?download=true"
